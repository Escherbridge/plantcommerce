...
<Section>
	<Container>
		<div class="prose max-w-4xl mx-auto">
			...
			<p>
				Aevani ("we," "our," or "us") is committed to protecting your privacy. This Privacy
			...
			<ul>
				...
				<li>Profile information (preferences, interests, demographics)</li>
				<li>Communication data (customer support inquiries, feedback)</li>
			</ul>
			...
			<p>
				...
				settings. See our <a href="/cookies" class="link link-primary">Cookie Policy</a> for more details.
			</p>
			...
			<div class="mt-8 p-6 bg-base-200 rounded-lg">
				...
				<div class="flex flex-wrap gap-4">
					...
					<a href="/cookies" class="link link-primary">Cookie Policy</a>
					<a href="/contact" class="link link-primary">Contact Us</a>
					<a href="/account/settings" class="link link-primary">Privacy Settings</a>
				</div>
			</div>
		</div>
	</Container>
