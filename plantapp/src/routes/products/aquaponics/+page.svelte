<script lang="ts">
	// Aquaponics landing page — same catalogue look, filtered to the system.
	...
	const SYSTEM = 'aquaponics';
	const TITLE = 'Aquaponics';
	const LEAD =
		'Fish and plants in one closed loop. Tanks, grow beds, bell siphons, water testing, and the fingerlings to stock them — balanced on our own systems before they earned a listing.';
