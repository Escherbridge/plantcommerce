<script lang="ts">
	// Agroforestry landing page — same catalogue look, filtered to the system.
	...
	const SYSTEM = 'agroforestry';
	const TITLE = 'Agroforestry';
	const LEAD =
		'Perennial crops for the long game. Tree seeds and seedlings, propagation and grafting kits — chosen for growers planting decades ahead.';
