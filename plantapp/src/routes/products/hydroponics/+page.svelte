<script lang="ts">
	// Hydroponics landing page — same catalogue look, filtered to the system.
	...
	const SYSTEM = 'hydroponics';
	const TITLE = 'Hydroponics';
	const LEAD =
		'Soil-free growing, dialed in. Vertical towers, NFT channels, aeroponic misters, nutrients and media — every system here ran a full grow cycle on our benches before we listed it.';
