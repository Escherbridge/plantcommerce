...
<svelte:head>
	<title>Sustainability evidence | Aevani</title>
	...
	<Container>
		...
		>
			<h1 class="font-display text-4xl font-bold tracking-tight uppercase">
				Sustainability evidence in review
			</h1>
			<p class="mt-5 text-lg leading-relaxed text-base-content/70">
				Aevani does not currently publish quantified environmental impact, sourcing, packaging,
				carbon, or community-program claims. Any future claim will include reviewed provenance and a
				verification date.
			</p>
