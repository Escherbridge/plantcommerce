...
export const mockCategories: MockCategory[] = [
	{
		...
		slug: 'aquaponics',
		description:
			'Complete aquaponics systems and components for sustainable fish and plant cultivation',
	...
	},
	{
		...
		imageUrl:
			'/src/lib/images/AI-MockAssets/Silvopasture&AgroforestryProducts-SilvopastureSeedMix.png'
	},
	{
		id: 4,
		name: 'Agroforestry',
		...
		imageUrl:
			'/src/lib/images/AI-MockAssets/Silvopasture&AgroforestryProducts-TreeShelters&Protectors.png'
	},
	{
		id: 5,
...
export const mockProducts: MockProduct[] = [
	// Aquaponics Products
	{
		...
		description:
			'Perfect for beginners, this compact countertop aquaponics system combines a clear acrylic fish tank with a grow bed for fresh herbs and greens. Watch the complete nitrogen cycle in action as fish waste nourishes your plants. Includes everything you need to get started: tank, grow bed, water pump, air pump, and detailed setup guide.',
		shortDescription:
			'Compact system perfect for growing fresh herbs and greens on your kitchen counter',
		price: '189.99',
		categoryId: 1,
		images: [
			{
	...
	},
	{
		...
		description:
			'Convert a standard IBC tote into a professional aquaponics fish tank with this complete conversion kit. Includes viewing window, bulkhead fittings, standpipe, and all necessary plumbing. 275-gallon capacity perfect for tilapia, koi, or goldfish. Food-grade materials ensure fish and plant safety.',
	...
	},
	{
		...
		description:
			'Complete water quality testing kit specifically designed for aquaponics systems. Test for pH, ammonia, nitrite, nitrate, and temperature - all critical parameters for healthy fish and plants. Includes 100+ tests, color comparison charts, and detailed guide for interpreting results and making adjustments.',
	...
	},
	{
		...
		description:
			'Comprehensive illustrated guide to raising tilapia in aquaponics systems. Covers fingerling selection, stocking density, feeding schedules, growth rates, and harvest timing. Beautiful botanical-style illustrations show different growth stages. Essential reading for anyone starting with tilapia aquaponics.',
	...
	// Hydroponic Products
	{
		...
		description:
			'Professional Nutrient Film Technique (NFT) system with 8 channels for maximum production. Each channel holds 12 net pots for a total of 96 plants. Continuous nutrient flow ensures optimal growth. Perfect for lettuce, herbs, and leafy greens. Includes reservoir, pump, and all necessary fittings. Expandable design allows you to add more channels as you grow.',
	...
	},
	{
		...
		description:
			'Professional 3-part nutrient system for all growth stages. Grow formula for vegetative growth, Bloom formula for flowering and fruiting, and Micro for essential micronutrients. pH balanced and highly concentrated - a little goes a long way. Suitable for all hydroponic systems and growing media. Each bottle makes 100+ gallons of nutrient solution.',
	...
	},
	{
		...
		description:
			'Variety pack of premium growing media for hydroponics. Includes rockwool starter cubes for seedlings, expanded clay pebbles (hydroton) for net pots, coco coir for moisture retention, and perlite for aeration. Everything you need to start seeds and transplant to your hydroponic system. Enough media for 50+ plants.',
	...
	},
	{
		...
		description:
			'Complete bundle of net pots and expanded clay pebbles. Includes 50 net pots in assorted sizes (2", 3", and 4") and 10 liters of premium hydroton clay pebbles. Net pots feature wide slits for excellent root development and aeration. Clay pebbles are pH neutral, reusable, and provide excellent drainage and oxygen to roots.',
	...
	},
	{
		...
		description:
			'Essential tool for rotational grazing in silvopasture systems. 164 feet of portable electric netting allows you to create temporary paddocks around trees. Includes energizer, ground rod, and step-in posts. Easy to move daily or weekly for intensive rotational grazing. Keeps chickens, sheep, or goats contained while protecting young trees. Solar energizer option available.',
	...
	},
	{
		...
		description:
			'Fast-growing nitrogen-fixing tree seeds perfect for silvopasture and agroforestry. Black locust improves soil fertility, provides durable fence posts, and offers excellent bee forage. Grows 3-4 feet per year. Seeds are scarified and ready to plant. Includes detailed germination and establishment guide. 100 seeds per packet, enough for 1-2 acres.',
	...
	// Kits & Collections
	{
		...
		description:
			'Everything you need to start your permaculture journey in one beautiful package. Includes heirloom seed collection (20 varieties), hand tools (trowel, cultivator, pruners), soil testing kit, companion planting guide, and biodegradable pots. Packaged in a reusable wooden crate. Perfect gift for aspiring permaculture gardeners or anyone wanting to grow food sustainably.',
	...
	},
	{
		...
		description:
			'Support bees, butterflies, and other pollinators with this curated seed collection. Includes 12 varieties of native wildflowers and herbs: milkweed, echinacea, bee balm, lavender, and more. All seeds are non-GMO and organically grown. Beautiful botanical illustration packets. Covers 100 square feet. Includes planting guide with bloom times for season-long nectar.',
	...
	},
	{
		...
		description:
			'Attract and house beneficial insects for natural pest control. Kit includes mason bee house, ladybug habitat, butterfly puddling station, and native plant seeds for nectar. Reduce or eliminate pesticide use by supporting natural predators. Includes educational guide about beneficial insects and their role in the garden ecosystem. Great for kids and adults alike.',
	...
	// Tools & Equipment
	{
		...
		description:
			"Heirloom-quality garden trowel hand-forged by skilled craftspeople. Carbon steel blade holds an edge and won't bend. Comfortable hardwood handle shaped to fit your hand. This is a tool you'll use for decades and pass down to the next generation. Each trowel is unique with subtle variations from the forging process. Comes with leather sheath.",
